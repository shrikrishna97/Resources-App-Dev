...
(References: [https://v3.vuex.vuejs.org/guide/actions.html](https://v3.vuex.vuejs.org/guide/actions.html), [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment))
...
`{ commit }` is JavaScript **object destructuring**.
It means: take only the `commit` property from the full `context` object.
...
This example shows how two components read and update the same Vuex state.
When one component updates `count`, the other component also updates automatically.
...
* Click in Component A, Component B updates.
* Click in Component B, Component A updates.
* Both are connected to the same shared Vuex state.
